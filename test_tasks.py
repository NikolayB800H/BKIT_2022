...
def test_task_b1():
    ...
    assert db.task_b1() == [('Асус_АУМ03', 145000, 'Класс 3Д моделирования'),
                            ('Асус_АУМ05', 125000, 'Класс 3Д моделирования')]

def test_task_b2():
    db = DataBase(classes, computers, computers_classes)
    assert db.task_b2() == [('Класс информатики', 125000),
                            ('Класс 3Д моделирования', 125000),
                            ('Класс генной инженерии', 135000)]

def test_task_b3():
    db = DataBase(classes, computers, computers_classes)
    assert db.task_b3() == [('Асус_АУМ03', 145000, 'Класс 3Д моделирования'),
